...
<div style="width: 80%;margin-left: 10%;">
    <nav class="navbar navbar-default navbar-static-top">
        <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand">讲师管理</a>
        </div>
            ...
            <ul class="nav panel-group" id="myPanel">
                ...
                <li class="panel">
                    ...
                    <ul id="sub1" class="nav panel-collapse collapse">
                        <li>
                            <a href="selectTeacher?unum=${unum}" id="showGood" target="main">
                ...
                <li class="panel">
                    ...
                    <ul id="sub2" class="nav panel-collapse collapse">
                        <li>
                            <a href="teacherCheckReport" id="showGoo" target="main">
                ...
                <li class="panel">
                    <a href="#sub4" data-toggle="collapse" data-parent="#myPanel"> 学生成绩管理
                        <span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
                    </a>
                    <ul id="sub4" class="nav panel-collapse collapse">
                        <li>
                            <a href="teacher/addScore.jsp" id="showG" target="main">
                                <span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;成绩录入
                            </a>
                        </li>
                        <li>
                            <a href="#" id="show" target="main">
                ...
                <li class="panel">
                    ...
                    <ul id="sub5" class="nav panel-collapse collapse">
                        <li>
                            <a href="#" id="sho">
                                <span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;学生信息查看
                            </a>
                        </li>
                    </ul>
                </li>
