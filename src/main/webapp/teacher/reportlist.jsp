            ...
            <div class="panel-body">
                ...
                <table id="tb_list" class="table table-striped table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <form action="teacherUpdateReport">
                        <td><input type="hidden" name="rid" value="${tbReportList.rid}"><input type="text" name="grade" value="${tbReportList.grade}">
                            <input type="submit" value="提交打分"></td>
                        </form>
                    </tr>
                    </c:forEach>
